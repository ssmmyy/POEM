...
with open(dataset, "r") as f:
    ...
    for data in reader:
        ...
        if opt.dataset == 'yoochoose' or opt.dataset == 'retailrocket':
            ...
            item = data['item_id'], datetime.datetime.strptime(data['eventdate'], '%Y-%m-%d')
        curdate = ''
        if opt.dataset == 'yoochoose' or opt.dataset == 'retailrocket':
...
if opt.dataset == 'diginetica':
    ...
    pickle.dump(tra, open('retailrocket/train.txt', 'wb'))
    pickle.dump(tes, open('retailrocket/test.txt', 'wb'))
    pickle.dump(all_train_seq, open('retailrocket/all_train_seq.txt', 'wb'))
elif opt.dataset == 'yoochoose':
    ...
    tra4, tra64 = (tr_ids[-split4:], tr_seqs[-split4:], tr_labs[-split4:]), (tr_ids[-split64:], tr_seqs[-split64:], tr_labs[-split64:])
